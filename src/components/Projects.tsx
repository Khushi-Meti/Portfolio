    ...
    <div className="card group">
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <span className="text-sm text-blue-600 dark:text-blue-400 font-medium px-3 py-1 bg-blue-100 dark:bg-blue-900/30 rounded-full">
            {project.date}
          </span>
        </div>
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          {project.technologies.map((tech, index) => (
            <span 
              key={index}
              className="inline-flex items-center text-xs px-2.5 py-1 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm transition-all duration-300 ${
                filter === tech
                  ...
                  : 'bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700/70'
              }`}
            >
