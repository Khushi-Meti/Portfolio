      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto mt-12">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              I'm a Computer Science graduate with a specialization in Data Science from Presidency University, Bangalore, where I maintained a CGPA of 7.99. My academic journey has equipped me with a strong foundation in both theoretical concepts and practical applications.
            </p>
            <p>
